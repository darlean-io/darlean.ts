...
async function main() {
    ...
    try {
        ...
        check(99, await priceOracle.ask('What is the price of an abracadabra?'), 'A newly learned fact should be used by the oracle');
        check(42, await temperatureOracle.ask('What is the price of an abracadabra?'), 'Another oracle instance should not know about the facts of another oracle');  
    } finally {
        await runner.stop();
    }
