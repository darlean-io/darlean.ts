...
export function required(typeDef: IValueDef<NativeStruct | NativePrimitive> | IValueClass<unknown>, fieldName?: CanonicalFieldName) {
    // eslint-disable-next-line @typescript-eslint/ban-types
...
export function optional(typeDef: IValueDef<NativeStruct | NativePrimitive> | IValueClass<unknown>, fieldName?: CanonicalFieldName) {
    // eslint-disable-next-line @typescript-eslint/ban-types
    return function (prototype: any, name: string, descriptor: PropertyDescriptor): void {
        const constr = prototype.constructor;
        let def = (constr as unknown as IStructValueClass).DEF;
