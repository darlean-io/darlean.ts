import { ArrayCanonical, BinaryCanonical, BoolCanonical, DictCanonical, FloatCanonical, IntCanonical, MapCanonical, MomentCanonical, StringCanonical } from '@darlean/canonical';
...
describe('JSON', () => {
    test('Struct', async () => {
        const struct = DictCanonical.from({
            ...
            'whisdom': ArrayCanonical.from([ BoolCanonical.from(true, ['fact']), BoolCanonical.from(false, ['fact']) ], ['facts']),
