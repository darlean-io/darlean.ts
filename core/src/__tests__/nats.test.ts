...
describe('Nats', () => {
    test('Remote via Nats', async () => {
        ...
        const cont0 = new InstanceContainer<IEchoActor>('EchoActor', (_id) => ({ instance: new EchoActor() }), 10);
        ...
        const cont1 = new InstanceContainer<IEchoActor>('EchoActor', (_id) => ({ instance: new EchoActor() }), 10);
